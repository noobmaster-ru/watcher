...
COPY packages/ozon-core packages/ozon-core
COPY apps/server apps/server
COPY apps/mcp apps/mcp
RUN npm run build -w @watcher/wb-core \
 && npm run build -w @watcher/ym-core \
 && npm run build -w @watcher/ozon-core \
...
COPY --from=builder /app/packages/ozon-core/dist packages/ozon-core/dist
